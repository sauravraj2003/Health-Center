...
const AddDoctor = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      formData.append("appointmentsPerDay", appointmentsPerDay === "" ? calculateMaxAppointments() : Number(appointmentsPerDay));
    ...
    <form className="m-5 w-full" onSubmit={(e) => onSubmitHandler(e)}>
      ...
      <div className="bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll">
        ...
        <div className="mt-4 border border-gray-200 rounded p-4">
          <p className="mb-2 font-medium text-gray-700">Doctor Availability</p>
          <div className="flex flex-col gap-4">
            <div>
              <p className="text-sm text-gray-600 mb-2">Available Days</p>
              <div className="flex flex-wrap gap-3">
                {["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map((day) => (
                  <label key={day} className="flex items-center gap-1 text-sm text-gray-600 cursor-pointer">
                    <input
                      type="checkbox"
            ...
            <div className="flex gap-6">
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  className="border rounded px-3 py-2 outline-primary text-gray-600"
                  required
                />
              </div>
              <div className="flex flex-col gap-1">
            ...
            <div className="flex gap-6 mt-4">
              <div className="flex flex-col gap-1">
                <p className="text-sm text-gray-600">Daily Appointment Limit (Max: {calculateMaxAppointments()})</p>
                <input
                  type="number"
                  value={appointmentsPerDay}
                  onChange={(e) => setAppointmentsPerDay(e.target.value)}
                  placeholder={`Max: ${calculateMaxAppointments()}`}
                  max={calculateMaxAppointments()}
                  min={1}
                  className="border rounded px-3 py-2 outline-primary text-gray-600"
                />
              </div>
